...
Pagy::DEFAULT[:limit]       = 50                    # default items per page
...
# See https://ddnexus.github.io/pagy/docs/extras/boot'trap
# require 'pagy/'xtras/bootstrap'

# Bulma extra: Add nav, nav_js and combo_nav_js helpers and templates for Bulma pagination
# See https://ddnexus.github.io/pagy/docs/extras/bulma
# require 'pagy/extras/bulma'

require "pagy/extras/pagy"  # Add the pagy styled versions of the javascript-powered navs
...
# Trim 'xtra: Remove the page=1 param from links
